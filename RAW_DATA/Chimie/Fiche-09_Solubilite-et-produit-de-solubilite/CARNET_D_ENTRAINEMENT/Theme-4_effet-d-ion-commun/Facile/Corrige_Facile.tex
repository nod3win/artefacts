...
\begin{enumerate}[label=\alph*),leftmargin=2em,topsep=2pt,itemsep=2pt]
  \item L'ion commun est l'ion \textbf{chlorure \ce{Cl-}} (déjà un produit de la dissolution de \ce{AgCl},
        apporté ici en excès par \ce{NaCl}).
  \item La solubilité \textbf{diminue}. Selon Le Chatelier, l'ajout de \ce{Cl-} déplace l'équilibre
        $\ce{AgCl(s) <=> Ag+ + Cl-}$ vers la \textbf{gauche} (formation du solide), pour consommer
        l'excès de \ce{Cl-}.
\end{enumerate}
\end{correction}

\begin{correction}[repérer l'ion commun]
\begin{enumerate}[label=\alph*),leftmargin=2em,topsep=2pt,itemsep=2pt]
  \item \ce{NaCl} apporte \ce{Cl-} : \textbf{ion commun} (avec l'anion de \ce{AgCl}). $\Rightarrow s\downarrow$.
  \item \ce{KNO3} apporte \ce{K+} et \ce{NO3-} : \textbf{aucun ion commun} avec \ce{AgCl}. Pas d'effet
        notable sur la solubilité.
  \item \ce{AgNO3} apporte \ce{Ag+} : \textbf{ion commun} (avec le cation de \ce{AgCl}). $\Rightarrow s\downarrow$.
\end{enumerate}
L'ion commun peut donc être le \emph{cation} \textbf{ou} l'\emph{anion}.
\end{correction}

\begin{correction}[application directe — \ce{AgCl}]
\begin{enumerate}[label=\alph*),leftmargin=2em,topsep=2pt,itemsep=2pt]
  \item $\Kps=[\ce{Ag+}][\ce{Cl-}]$ reste vrai ; avec $[\ce{Cl-}]$ imposé,
        $s'=[\ce{Ag+}]=\dfrac{\Kps}{[\ce{Cl-}]}$.
  \item $s'=\dfrac{\num{1{,}8e-10}}{0{,}10}=\boxed{\qty{1{,}8e-9}{\molar}}$ (soit $10\times\Kps$).
        \emph{(Réponse C du \textsc{qcm}\,n\textsuperscript{o}\,8 ; le choix « $10\sqrt{\Kps}$ » est un piège.)}
\end{enumerate}
\end{correction}

\begin{correction}[comparer eau pure / ion commun]
\begin{enumerate}[label=\alph*),leftmargin=2em,topsep=2pt,itemsep=2pt]
  \item $s_0=\sqrt{\Kps}=\sqrt{\num{1{,}8e-10}}\approx\qty{1{,}3e-5}{\molar}$.
  \item Facteur $\dfrac{s_0}{s'}=\dfrac{\num{1{,}3e-5}}{\num{1{,}8e-9}}\approx\boxed{7000}$. La
        solubilité est divisée par environ \num{7000} : l'ion commun « chasse » l'argent de la solution.
\end{enumerate}
\end{correction}

\begin{correction}[formule pour un sel $1{:}2$]
$\ce{MX2(s) <=> M^{2+} + 2 X-}$, donc $\Kps=[\ce{M^2+}][\ce{X-}]^{2}$.
\begin{enumerate}[label=\alph*),leftmargin=2em,topsep=2pt,itemsep=2pt]
  \item L'anion est surtout apporté par la solution : $[\ce{X-}]\approx C$, et $[\ce{M^2+}]=s'$. D'où
        $\Kps\approx s'\times C^{2}$.
  \item $\boxed{\ s'=\dfrac{\Kps}{C^{2}}\ }$ (cas particulier $n=2$ de $s'=\Kps/C^{\,n}$).
\end{enumerate}
\end{correction}
