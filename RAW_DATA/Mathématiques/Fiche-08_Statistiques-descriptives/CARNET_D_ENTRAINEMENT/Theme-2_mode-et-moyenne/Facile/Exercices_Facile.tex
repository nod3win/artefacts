...
\newcommand{\ect}{\sigma}
\newcommand{\med}{M\!e}
\docpart{Facile — Thème 2}
\begin{document}
\bandeau{Thème 2 — Mode et moyenne}{Niveau Facile — exercices}

\noindent\textit{Objectif : lire un mode et calculer une moyenne pondérée, un geste à la fois.}\medskip

\begin{exobox}{Exercice 1 — Mode (série discrète)}
Pointures vendues dans un magasin en une journée :
\begin{center}
\begin{tabular}{|c|c|c|c|c|}
\hline
Pointure & 38 & 39 & 40 & 41 \\\hline
$n_i$ & 5 & 12 & 9 & 3 \\\hline
\end{tabular}
\end{center}
Quel est le mode ? (Attention : donner la \emph{pointure}, pas l'effectif.)
\end{exobox}

\begin{exobox}{Exercice 2 — Mode (série en classes)}
\begin{center}
...
\begin{exobox}{Exercice 3 — Moyenne pondérée}
Une série discrète : la valeur $10$ apparaît $2$ fois, la valeur $12$ apparaît $3$ fois, la valeur
$15$ apparaît $5$ fois. Calculer la moyenne $m$.
\end{exobox}

\begin{exobox}{Exercice 4 — Ajouter une constante}
La moyenne des masses d'un groupe d'objets est $m=12$\,g. On ajoute $3$\,g à chaque objet.
Que vaut la nouvelle moyenne ?
\end{exobox}

\begin{exobox}{Exercice 5 — Multiplier par un facteur}
La moyenne d'une série est $m=12$. On multiplie \emph{chaque} valeur par $0{,}5$.
Que vaut la nouvelle moyenne ?
\end{exobox}
\end{document}
