...
\newcommand{\ect}{\sigma}
\newcommand{\med}{M\!e}
\docpart{Facile — Thème 1}
\begin{document}
\bandeau{Thème 1 — Le tableau statistique}{Niveau Facile — exercices}

\noindent\textit{Objectif : automatiser chaque colonne du tableau, une à la fois. Arrondir les
fréquences à $0{,}01$.}\medskip

\begin{exobox}{Exercice 1 — Centre de classe}
Calculer le centre $x_i=\dfrac{a+b}{2}$ de chacune des classes suivantes :
\[
\text{(a) } [55,65[ \qquad \text{(b) } [100,110[ \qquad \text{(c) } [0,4[ \qquad
\text{(d) } [12{,}5\,;\,17{,}5[ .
\]
\end{exobox}

\begin{exobox}{Exercice 2 — Effectif total}
Une série comporte six classes d'effectifs :
\[ n_1=3,\ n_2=7,\ n_3=12,\ n_4=15,\ n_5=8,\ n_6=5. \]
Calculer l'effectif total $N$.
\end{exobox}

\begin{exobox}{Exercice 3 — Fréquence}
Dans une population de $N=50$ individus, une classe contient $n_i=18$ individus.
Calculer sa fréquence $f_i$, puis l'exprimer en pourcentage.
\end{exobox}

\begin{exobox}{Exercice 4 — Effectifs cumulés}
Recopier et compléter la colonne des effectifs cumulés $n_c$ :
\begin{center}
...
$n_i$ & 6 & 11 & 9 & 4 \\\hline
$n_c$ & \dots & \dots & \dots & \dots \\\hline
\end{tabular}
\end{center}
Que vaut la dernière case ? Que doit-elle valoir ?
\end{exobox}

\begin{exobox}{Exercice 5 — Retrouver un effectif}
Dans une population de $N=200$ patients, une catégorie représente une fréquence $f_i=0{,}15$.
Combien de patients cette catégorie contient-elle ?
\end{exobox}
\end{document}
