...
\newcommand{\ect}{\sigma}
\newcommand{\med}{M\!e}
\docpart{Difficile — Thème 4}
\begin{document}
\bandeau{Thème 4 — Les indicateurs de dispersion}{Niveau Difficile — exercices}

\noindent\textit{Objectif : mener une étude de dispersion complète, et comparer des écarts types
« à l'œil » comme au concours.}\medskip

\begin{exobox}{Exercice 1 — Étude de dispersion complète (mise en situation)}
On mesure la \textbf{glycémie à jeun} (en mg/dL) de $N=50$ patients :
\begin{center}
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{|c|c|c|c|c|c|}
\hline
Classes (mg/dL) & $[70,90[$ & $[90,110[$ & $[110,130[$ & $[130,150[$ & $[150,170[$ \\\hline
$x_i$ & 80 & 100 & 120 & 140 & 160 \\\hline
$n_i$ & 6 & 14 & 18 & 8 & 4 \\\hline
\end{tabular}
\end{center}
\begin{enumerate}[label=\textbf{(\alph*)}]
  \item Calculer l'étendue.
  \item Calculer la moyenne $m$.
  \item Calculer la variance $V$ par le théorème de König--Huygens.
  \item En déduire l'écart type $\ect$ et l'interpréter en une phrase.
  \item Vérifier que $V\geqslant0$ et préciser l'unité de $V$ et de $\ect$.
\end{enumerate}
\end{exobox}

\begin{exobox}{Exercice 2 — Comparer trois écarts types}
Trois séries de six données :
\[
(1):\{1,3,5,7,9,11\}\quad (2):\{1,2,5,7,10,11\}\quad (3):\{1,4,5,7,8,11\}.
\]
\begin{enumerate}[label=\textbf{(\alph*)}]
  \item Vérifier que les trois séries ont la même moyenne.
  \item Calculer la variance de chacune (les valeurs étant équiréparties, $N$ non pondéré).
  \item Laquelle a le plus petit écart type ? Justifier sans calculatrice.
  \item Sans nouveau calcul, laquelle a le plus grand écart type ?
\end{enumerate}
\end{exobox}
\end{document}
