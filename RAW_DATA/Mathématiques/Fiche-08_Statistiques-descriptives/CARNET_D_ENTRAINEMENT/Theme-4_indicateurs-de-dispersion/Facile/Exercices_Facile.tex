...
\newcommand{\ect}{\sigma}
\newcommand{\med}{M\!e}
\docpart{Facile — Thème 4}
\begin{document}
\bandeau{Thème 4 — Les indicateurs de dispersion}{Niveau Facile — exercices}

\noindent\textit{Objectif : isoler chaque brique du calcul de dispersion. Arrondir à $0{,}01$.}\medskip

\begin{exobox}{Exercice 1 — Étendue}
\begin{center}
...
\begin{exobox}{Exercice 2 — Écart à la moyenne}
La moyenne d'une série est $m=15$. Calculer l'écart $|m-x_i|$ pour chacune des valeurs
$x=10,\ 12,\ 18,\ 20$.
\end{exobox}

\begin{exobox}{Exercice 3 — Écart moyen}
Série : $x=2\,(n{=}1),\ 4\,(n{=}2),\ 6\,(n{=}1)$, de moyenne $m=4$ et $N=4$.
Calculer l'écart moyen $\ecm=\dfrac{1}{N}\sum n_i|m-x_i|$.
\end{exobox}

\begin{exobox}{Exercice 4 — Variance par König--Huygens}
On donne $\dfrac{1}{N}\sum n_i x_i^{\,2}=169$ et une moyenne $m=12$.
Calculer la variance $V=\dfrac{1}{N}\sum n_i x_i^{\,2}-m^2$.
\end{exobox}

\begin{exobox}{Exercice 5 — Écart type}
Une série a pour variance $V=144$. Calculer l'écart type $\ect$.
\end{exobox}
\end{document}
