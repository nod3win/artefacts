...
{\small\itshape Exercices --- Niveau Moyen : tableau de variation complet, compter les extremums}
\end{center}
\vspace{2mm}

\begin{exo}[1]
Soit $f(x)=x^3-3x^2+1$. Dresser le tableau de variation complet et donner
les extremums avec leurs valeurs.
\end{exo}

\begin{exo}[2]
Soit $f(x)=3x^3-3x^2+x+1$. Étudier les variations de $f$.
\end{exo}

\begin{exo}[3]
Soit $f(x)=\dfrac{x^5}{5}-16x$. Combien $f$ possède-t-elle d'extremums ?
\end{exo}

\begin{exo}[4]
Soit $f(x)=\dfrac{x}{x+1}$ (définie pour $x\neq -1$). Déterminer le sens de variation de $f$.
\end{exo}

\begin{exo}[5]
Soit $f(x)=x+\dfrac{1}{x}$ (définie pour $x\neq 0$). Déterminer les extremums de $f$.
\end{exo}
