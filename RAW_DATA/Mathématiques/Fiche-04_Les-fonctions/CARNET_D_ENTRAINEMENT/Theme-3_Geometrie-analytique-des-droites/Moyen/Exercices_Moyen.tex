...
\begin{document}
\titrecarnet{Thème 3 — Géométrie analytique des droites}{Exercices — niveau Moyen}{Parallèles, perpendiculaires, distance point–droite, intersection.}

\exercice{1}
Déterminer l'équation de la droite parallèle à $y=2x+1$ passant par le point $(0;4)$.

\exercice{2}
Déterminer l'équation de la droite perpendiculaire à $y=3x-1$ passant par l'origine.

\exercice{3}
Calculer la distance du point $P(1;1)$ à la droite $d:\ 3x+4y-5=0$.

\exercice{4}
Déterminer les coordonnées du point d'intersection des droites $y=2x$ et $y=-2x+3$.
