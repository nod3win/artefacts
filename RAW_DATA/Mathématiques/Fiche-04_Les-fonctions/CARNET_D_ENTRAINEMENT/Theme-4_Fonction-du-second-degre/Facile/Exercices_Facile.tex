...
\begin{document}
\titrecarnet{Thème 4 — Fonction du second degré}{Exercices — niveau Facile}{Discriminant, racines, sommet, ordonnée à l'origine.}

\exercice{1}
Calculer le discriminant de $x^2-5x+6$ et en déduire ses racines.

\exercice{2}
Calculer le discriminant de $x^2-4x+4$. Combien de racines ? Laquelle (lesquelles) ?

\exercice{3}
Calculer le discriminant de $x^2+x+1$. Combien de racines réelles ? Quel est le signe de ce trinôme ?
...
\exercice{5}
Déterminer l'intersection avec l'axe des ordonnées de $f(x)=2x^2-3x+5$.
\end{document}
