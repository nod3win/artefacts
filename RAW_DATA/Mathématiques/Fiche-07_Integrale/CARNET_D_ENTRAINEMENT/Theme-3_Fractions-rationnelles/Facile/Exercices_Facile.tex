...
\begin{document}
\section*{Thème 3 — Fractions rationnelles \quad\textbullet\quad Niveau Facile}

\begin{center}\itshape
Numérateur constant, dénominateur factorisé en deux pôles simples distincts.\\
Pour chaque exercice : décomposer en fractions simples, puis donner une primitive.
\end{center}
...
\begin{exo}[2]
Calculer $\displaystyle\int \frac{1}{(x-2)(x-4)}\,\dd x$.
\end{exo}

\begin{exo}[3]
Calculer $\displaystyle\int \frac{3}{(x+1)(x-2)}\,\dd x$.
\end{exo}

\begin{exo}[4]
La fraction est déjà factorisée. Calculer
$\displaystyle\int \frac{5}{(x-3)(x+2)}\,\dd x$.
\end{exo}

\begin{exo}[5]
Un des pôles vaut $0$. Calculer
$\displaystyle\int \frac{4}{x(x-4)}\,\dd x$.
\end{exo}
