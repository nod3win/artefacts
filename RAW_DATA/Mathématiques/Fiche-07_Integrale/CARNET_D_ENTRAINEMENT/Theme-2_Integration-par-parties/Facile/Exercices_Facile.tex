...
\begin{document}
\section*{Niveau Facile — une seule IPP}

\emph{Objectif : une IPP unique, avec un polynôme de degré~1 (à dériver) et une exponentielle ou une
fonction trigonométrique (à intégrer). Pense à écrire le choix $U/V'$ avant tout calcul, et à vérifier en dérivant.}
...
\begin{exo}[3]
Calculer $\displaystyle \int x\sin x\,\dd x$.
\end{exo}
...
\begin{exo}[5]
Calculer $\displaystyle \int (x+2)\,e^{x}\,\dd x$.
\end{exo}
\end{document}
