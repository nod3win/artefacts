...
\begin{document}
\section*{Niveau Moyen — logarithme, réciproques et double IPP}

\emph{Ici $U$ n'est plus forcément un polynôme : la règle L.I.A.T.E. impose parfois de dériver un $\ln$
ou un $\arctan$. Certains calculs demandent une \textbf{deuxième} IPP.}

\begin{exo}[1]
Calculer $\displaystyle \int \ln x\,\dd x$ (sur $]0,+\infty[$). \textit{Indication : écrire $\ln x=1\cdot\ln x$.}
\end{exo}

\begin{exo}[2]
Calculer $\displaystyle \int x\ln x\,\dd x$ (sur $]0,+\infty[$).
\end{exo}

\begin{exo}[3]
Calculer $\displaystyle \int \arctan x\,\dd x$. \textit{Indication : $U=\arctan x$, $V'=1$.}
\end{exo}

\begin{exo}[4]
Calculer $\displaystyle \int x\,e^{2x}\,\dd x$. \textit{Attention à la primitive de $e^{2x}$.}
\end{exo}

\begin{exo}[5]
Calculer $\displaystyle \int x^{2}\,e^{x}\,\dd x$ (deux IPP successives).
\end{exo}
\end{document}
